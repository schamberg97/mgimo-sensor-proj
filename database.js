...
pipe.on('error', (err) => {
	if (process.env.DEBUG == "true") {
		...
		if (os.platform == "darwin") {
			...
			var mongoInstallChild = spawn('cmd', ["/S /C " + `${__dirname}/platform/win64/dist/mongodb-win32-x86_64-2012plus-4.2.3-signed.msi`], { // /S strips quotes and /C executes the runnable file (node way)
